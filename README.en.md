...
[![Kubernetes](https://img.shields.io/badge/Kubernetes-ready-326ce5?style=flat-square&logo=kubernetes&logoColor=white)](docs/KUBERNETES.en.md)
...
[docs/BELLEK.en.md](docs/BELLEK.en.md)
...
[docs/BACKUP.en.md](docs/BACKUP.en.md).
...
Details and per-engine methods: [docs/BACKUP.en.md](docs/BACKUP.en.md).
Remote storage (Google Drive / S3 / SFTP):
[docs/GOOGLE-DRIVE.en.md](docs/GOOGLE-DRIVE.en.md).
...
done in this round. Details: [docs/PITR.en.md](docs/PITR.en.md).
...
and is written down in [docs/BACKUP.en.md](docs/BACKUP.en.md).
...
literals and says so. Details: [docs/SLOWLOG.en.md](docs/SLOWLOG.en.md).
...
Details: [docs/MONITORING.en.md](docs/MONITORING.en.md).
...
Details: [docs/REPLICATION.en.md](docs/REPLICATION.en.md)
...
[docs/FAILOVER.en.md](docs/FAILOVER.en.md)
...
Details: [docs/KUBERNETES.en.md](docs/KUBERNETES.en.md)
...
Details and hardening steps: [docs/SECURITY.en.md](docs/SECURITY.en.md)
...
Kubernetes (see [docs/FAILOVER.en.md](docs/FAILOVER.en.md)). As long as you run
...
network. Details: [docs/LICENSING.en.md](docs/LICENSING.en.md)
