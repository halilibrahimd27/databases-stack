...
GUVENLI=(security sizing replication failover ha-drill backup drill shadow schema recovery-set import
...
declare -A ACIKLAMA=(
  ...
  [recovery-set]="Kurtarma noktası: pencere ölçülüyor, geri yükleme o ana döndürüyor, eksik dosya saklanmıyor"
